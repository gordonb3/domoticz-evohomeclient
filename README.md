...
1. [Windows 32bit]( ../../releases/download/1.2.0/evo-client-win-x86-1.2.0.zip )
1. [Linux 32bit]( ../../releases/download/1.2.0/evo-client-linux-x86-1.2.0.tar.gz )
1. [Linux 64bit]( ../../releases/download/1.2.0/evo-client-linux-x64-1.2.0.tar.gz )
1. [Linux armv5te]( ../../releases/download/1.2.0/evo-client-linux-armv5te-1.2.0.tar.gz )<br>
(e.g. Excito B3, SheevaPlug, Linksys NSLU2, QNAP TS109/209/409, ...)
1. [Linux armv7l]( ../../releases/download/1.2.0/evo-client-linux-armv7l-1.2.0.tar.gz ) !!! Untested<br>
(e.g. Rpi2|3 32bit)
